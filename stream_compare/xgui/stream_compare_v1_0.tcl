...
proc init_gui { IPINST } {
  ...
  set TRIGGER [ipgui::add_param $IPINST -name "TRIGGER" -parent ${Page_0}]
  set_property tooltip {Produce trigger output on mismatches} ${TRIGGER}
...
proc update_PARAM_VALUE.TRIGGER { PARAM_VALUE.TRIGGER } {
	# Procedure called to update TRIGGER when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TRIGGER { PARAM_VALUE.TRIGGER } {
	# Procedure called to validate TRIGGER
	return true
}
