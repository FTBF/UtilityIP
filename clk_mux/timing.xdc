...
set_clock_groups -name muxed_clocks -physically_exclusive \
    -group [get_clocks -include_generated_clocks -of_objects [get_pins {BUFGCTRL_320_inst/I0 BUFGCTRL_40_inst/I0}]] \
    -group [get_clocks -include_generated_clocks -of_objects [get_pins {BUFGCTRL_320_inst/I1 BUFGCTRL_40_inst/I1}]]
