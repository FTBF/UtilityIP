...
source [file join [file dirname [file dirname [info script]]] gui/multiLFSR_v1_0.gtcl]
...
proc init_gui { IPINST } {
  ...
  set N_CHANNELS [ipgui::add_param $IPINST -name "N_CHANNELS" -parent ${page0}]
  set_property tooltip "Number of 32-bit channels" ${N_CHANNELS}
