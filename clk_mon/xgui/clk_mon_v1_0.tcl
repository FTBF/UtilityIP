...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NCLK" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SPLIT_INPUTS" -parent ${Page_0}
...
proc update_PARAM_VALUE.SPLIT_INPUTS { PARAM_VALUE.SPLIT_INPUTS } {
	# Procedure called to update SPLIT_INPUTS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SPLIT_INPUTS { PARAM_VALUE.SPLIT_INPUTS } {
	# Procedure called to validate SPLIT_INPUTS
	return true
}
...
proc update_MODELPARAM_VALUE.SPLIT_INPUTS { MODELPARAM_VALUE.SPLIT_INPUTS PARAM_VALUE.SPLIT_INPUTS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SPLIT_INPUTS}] ${MODELPARAM_VALUE.SPLIT_INPUTS}
}
